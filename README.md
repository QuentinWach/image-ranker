...
- **Various advanced ranking speedups.** Rank $N$ images in $\mathcal{O}(N)$-time (rather than $\mathcal{O}(N \times (N-1)/2)$) by eliminating images from the ranking that have been down voted and shuffle images to minimize uncertainty as fast as possible.
- **1v1 or best-of-four ranking.** You can choose to rank images 1v1 or pick the best image out of four images. The best-of-four is much faster, but the 1v1 is more accurate.
